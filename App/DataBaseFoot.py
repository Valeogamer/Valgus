...
class DBFootPronation(db.Model):
    ...
    LF = db.Column(db.Integer, nullable=False)
    RF = db.Column(db.Integer, nullable=False)
    TLF = db.Column(db.Integer, nullable=False, default=0)
    TRF = db.Column(db.Integer, nullable=False, default=0)
