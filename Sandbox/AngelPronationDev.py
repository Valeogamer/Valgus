...
def image_process(img_path=None, file_name=None):
    ...
    foots.left_foot.parameters(top=70, middle=30, bottom=1)  # процентное сотноошение по высоте с низу вверх
    foots.right_foot.parameters(top=70, middle=30, bottom=1)  # от ступни до голени
